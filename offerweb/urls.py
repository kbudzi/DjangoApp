...
from offerweb.views import wszystkie_oferty,nowa_oferta, glowna, wybierz_indeks,edytuj_top_oferty,edytuj_oferte, operacje, kontrahent, nowy_kontrahent, edytuj_kontrahent, usun_kontrahenta, usun_oferte ,usun_indeks, edytuj_indeks
...
urlpatterns = [
    ...
    path('wybierz_indeks/', wybierz_indeks, name="wybierz_indeks"),
